                        ...
                        <div class="bg-white dark:bg-gray-800 shadow-sm sm:rounded-lg p-6">
                            <div class="space-y-4">
                                <div>
                                    ...
                                    <x-text-input id="title" name="title" type="text" class="mt-1 block w-full" :value="old('title', $blogPost->title)" required autofocus />
                                    <x-input-error class="mt-2" :messages="$errors->get('title')" />
                                </div>

                                <div>
                                    <x-input-label for="content" :value="__('Content')" />
                                    <textarea id="content" name="content" rows="15" class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 shadow-sm" required>{{ old('content', $blogPost->content) }}</textarea>
                    ...
                    <div class="space-y-6">
                        <div class="bg-white dark:bg-gray-800 shadow-sm sm:rounded-lg p-6">
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="flex items-center">
                                    <x-checkbox id="is_published" name="is_published" :checked="old('is_published', $blogPost->is_published)" />
                                    <x-input-label for="is_published" :value="__('Published')" class="ml-2" />
                                </div>

                                <div class="flex items-center">
                                    <x-checkbox id="is_on_home" name="is_on_home" :checked="old('is_on_home', $blogPost->is_on_home)" />
                        ...
                        <div class="bg-white dark:bg-gray-800 shadow-sm sm:rounded-lg p-6">
                            ...
                            <div class="space-y-4">
                                @if($blogPost->image)
                                    <div class="mb-4">
                                        <img src="{{ Storage::url($blogPost->image) }}" alt="" class="w-full h-auto rounded-md shadow-sm">
                                    </div>
                                @endif
