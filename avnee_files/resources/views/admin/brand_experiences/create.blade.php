<x-admin-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            {{ __('Create Brand Experience') }}
        </h2>
    </x-slot>

    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <form action="{{ route('admin.brand-experiences.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                        ...
                        <div class="bg-white dark:bg-gray-800 p-6 shadow sm:rounded-lg">
                            ...
                            <div class="grid grid-cols-2 gap-4 mb-4">
                                ...
                                <div>
                                    ...
                                    <select id="layout_type" name="layout_type" class="mt-1 block w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">
                                        <option value="layout_1">Layout 1 (Editorial Stack)</option>
                                        <option value="layout_2">Layout 2 (Visual Grid)</option>
                                        <option value="layout_3">Layout 3 (Classic Split Grid)</option>
                                    </select>
                            ...
                            <div class="space-y-4">
                                ...
                                <div>
                                    ...
                                    <x-text-input id="content_title" name="content_title" type="text" class="mt-1 block w-full" :value="old('content_title')" />
                                ...
                                <div>
                                    ...
                                    <textarea id="content_description" name="content_description" rows="3" class="mt-1 block w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">{{ old('content_description') }}</textarea>
                                ...
                                <div class="grid grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <x-text-input id="button_text" name="button_text" type="text" class="mt-1 block w-full" :value="old('button_text', 'SHOP NOW')" />
                                    </div>
                                    <div>
                                ...
                                <div class="flex items-center gap-6">
                                    <div>
                                        ...
                                        <x-text-input id="sort_order" name="sort_order" type="number" class="mt-1 block w-20" :value="old('sort_order', 0)" />
                                    </div>
                        ...
                        <div class="bg-white dark:bg-gray-800 p-6 shadow sm:rounded-lg">
                            ...
                            <div class="space-y-6">
                                ...
                                <div class="p-4 border border-dashed rounded-lg bg-gray-50 dark:bg-gray-700/30">
                                    ...
                                    <x-text-input name="image_1_label" placeholder="Panda Cuteness" class="mt-2 block w-full text-sm" />
                                </div>

                                <!-- Image 2 -->
                                <div class="p-4 border border-dashed rounded-lg bg-gray-50 dark:bg-gray-700/30">
                                    <x-input-label for="image_2" :value="__('Image 2 (Top Stack in Layout 1 / Top Right in Layout 2)')" />
                                    <input id="image_2" name="image_2" type="file" class="mt-1 block w-full text-xs" />
                                    <x-text-input name="image_2_label" placeholder="Label for image 2" class="mt-2 block w-full text-sm" />
                                </div>

                                <!-- Image 3 -->
                                <div class="p-4 border border-dashed rounded-lg bg-gray-50 dark:bg-gray-700/30">
                                    <x-input-label for="image_3" :value="__('Image 3 (Bottom Stack in Layout 1 / Bottom Left in Layout 2)')" />
                                    <input id="image_3" name="image_3" type="file" class="mt-1 block w-full text-xs" />
                                    <x-text-input name="image_3_label" placeholder="Adorable Characters" class="mt-2 block w-full text-sm" />
                                </div>

                                <!-- Image 4 (Layout 2 Only) -->
                                <div class="p-4 border border-dashed rounded-lg bg-gray-50 dark:bg-gray-700/30">
                                    <x-input-label for="image_4" :value="__('Image 4 (Bottom Right in Layout 2)')" />
                                    <input id="image_4" name="image_4" type="file" class="mt-1 block w-full text-xs" />
                                    <x-text-input name="image_4_label" placeholder="Elegant & Trendy for Women" class="mt-2 block w-full text-sm" />
                                </div>
                            </div>
                        </div>
                    </div>
