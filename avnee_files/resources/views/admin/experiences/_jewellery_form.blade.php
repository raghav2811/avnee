<div class="grid grid-cols-1 lg:grid-cols-3 gap-10">
    <div class="lg:col-span-2 space-y-8">
        <div class="glass-card rounded-2xl p-8 space-y-6 shadow-2xl">
            <h3 class="text-sm font-bold uppercase tracking-widest text-purple-400 mb-4">Jewellery Master Copy</h3>
        ...
        <div class="glass-card rounded-2xl p-8 shadow-2xl">
            <h3 class="text-sm font-bold uppercase tracking-widest text-purple-400 mb-8">Craft Detail Showcase (Square 800x800)</h3>
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div class="space-y-4">
                    ...
                    <input type="file" name="detail_image_{{ $i }}" class="text-[9px] text-gray-500 file:mr-4 file:py-1 file:px-3 file:rounded-full file:border-0 file:bg-purple-900/10 file:text-purple-400 hover:file:bg-purple-900/20 mb-2">
                    @if($setting->$field)
    ...
    <div class="space-y-10">
        <div class="glass-card rounded-2xl p-8 shadow-2xl border-purple-500/10">
            <h3 class="text-sm font-bold uppercase tracking-widest text-purple-400 mb-6 block text-center">Main Campaign (3:4 Ratio, 1200x1600)</h3>
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <label class="flex items-center gap-1.5 cursor-pointer group">
                        ...
                        <div class="w-3.5 h-3.5 border border-white/20 rounded flex items-center justify-center peer-checked:bg-purple-500 peer-checked:border-purple-500 transition-all">
                            <span class="material-symbols-outlined text-[10px] text-white opacity-0 peer-checked:opacity-100">close</span>
                        </div>
                        <span class="text-[9px] text-gray-500 font-bold uppercase tracking-widest group-hover:text-purple-400 transition-colors">Remove Current Image</span>
                    </label>
                    @endif
                </div>
                <div>
                    ...
                    <label class="flex items-center gap-1.5 cursor-pointer group">
                        ...
                        <span class="text-[9px] text-gray-500 font-bold uppercase tracking-widest group-hover:text-purple-400 transition-colors">Remove Current Video</span>
                    </label>
                    @endif
                </div>
            </div>
        ...
        <button type="submit" class="w-full py-4 bg-purple-600 text-white text-[11px] font-bold uppercase tracking-[0.2em] rounded-full shadow-lg shadow-purple-600/30 hover:bg-purple-700 transition-all flex items-center justify-center gap-2">
            <span class="material-symbols-outlined text-sm">auto_fix_high</span> PUBLISH JEWELLERY EXPERIENCE
        </button>
    </div>
</div>
