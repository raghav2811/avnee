        ...
        <div class="max-w-[700px] mx-auto">
            <div class="bg-gradient-to-br from-[#1c181d] to-[#120e11] rounded-[40px] p-12 border border-white/5 shadow-2xl">
                <div class="flex flex-col items-center justify-center text-center">
                    ...
                    <h1 class="text-4xl font-heading font-normal tracking-tight bg-gradient-to-r from-white to-gray-400 bg-clip-text text-transparent mb-2">Create Style</h1>
                    <p class="text-sm text-gray-500 mb-12 uppercase tracking-[0.2em] font-bold">New Home Page Style Card</p>
                </div>

                <form action="{{ route('admin.home-styles.store') }}" method="POST" enctype="multipart/form-data" class="space-y-10">
                    @csrf
                    ...
                    <div class="grid grid-cols-1 gap-8">
                        ...
                        <div class="space-y-4">
                            ...
                            <input type="text" name="title" class="w-full bg-[#350047]/50 border border-white/10 rounded-2xl px-6 py-4 text-sm text-gray-300 focus:outline-none focus:ring-1 focus:ring-[#b87333] transition-all" placeholder="e.g., Infant Sets" required>
                        </div>

                        <div class="space-y-4">
                            <label class="text-[10px] items-center px-4 py-2 font-bold uppercase tracking-[0.2em] text-gray-500">Redirect Link</label>
                            <input type="text" name="redirect_url" class="w-full bg-[#350047]/50 border border-white/10 rounded-2xl px-6 py-4 text-sm text-gray-300 font-mono focus:outline-none focus:ring-1 focus:ring-[#b87333] transition-all" placeholder="/products?category=infant-sets">
                        </div>

                        <div class="space-y-4">
                             <label class="text-[10px] items-center px-4 py-2 font-bold uppercase tracking-[0.2em] text-gray-500">Style Image (1:1 Ratio Recommended)</label>
                             <div class="mt-2 flex justify-center px-6 pt-10 pb-12 border-2 border-white/10 border-dashed rounded-[32px] hover:border-[#b87333]/30 transition-all cursor-pointer bg-black/20 group relative overflow-hidden">
                                ...
                                <div class="space-y-2 text-center group-hover:scale-110 transition-transform duration-500">
                                    ...
                                    <p class="text-[9px] text-gray-700 italic">Square Aspect Recommended</p>
                                </div>
                             </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                            ...
                            <div class="flex items-center gap-3 pt-6">
                                <input type="checkbox" name="is_active" value="1" checked class="w-4 h-4 rounded-sm bg-[#350047] border-white/10 text-[#b87333] focus:ring-Offset-0 focus:ring-transparent transition-all">
